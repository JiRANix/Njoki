...
Route::group(['prefix' => 'v2'], function() {
    ...
    Route::post('stkPush','App\Http\Controllers\Api\V2\OrderController@stkPush')->name('stkPush');
    Route::post('stkCallBack/{orderId}','App\Http\Controllers\Api\V2\OrderController@stkCallBack')->name('stkCallBack');
